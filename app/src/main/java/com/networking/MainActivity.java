...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ANImageView.setDefaultImageResId(R.drawable.ic_toys);
        ANImageView.setErrorImageResId(R.drawable.ic_error_outline);
    ...
    public void loadImageFromImageLoader(View view) {
        ANImageLoader.getInstance().get(URL_IMAGE_LOADER, ANImageLoader.getImageListener(imageView,
                R.drawable.ic_toys, R.drawable.ic_error_outline));
    }
